...
public enum ParticleEffect {
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        ...
        if (this.hasProperty(ParticleProperty.REQUIRES_DATA)) throw new ParticleDataException("This particle effect requires additional data");
        if (this.hasProperty(ParticleProperty.REQUIRES_WATER) && !ParticleEffect.isWater(center)) throw new IllegalArgumentException("There is no water at the center location");
    ...
    public void display(Vector direction, float speed, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        if (!this.isSupported()) throw new ParticleVersionException("This particle effect is not supported by your server version");
        if (this.hasProperty(ParticleProperty.REQUIRES_DATA)) throw new ParticleDataException("This particle effect requires additional data");
        if (!this.hasProperty(ParticleProperty.DIRECTIONAL)) throw new IllegalArgumentException("This particle effect is not directional");
        if (this.hasProperty(ParticleProperty.REQUIRES_WATER) && !ParticleEffect.isWater(center)) throw new IllegalArgumentException("There is no water at the center location");
    ...
    public void display(ParticleColor color, Location center, double range) throws ParticleVersionException, ParticleColorException {
        if (!this.isSupported()) throw new ParticleVersionException("This particle effect is not supported by your server version");
        if (!this.hasProperty(ParticleProperty.COLORABLE)) throw new ParticleColorException("This particle effect is not colorable");
        if (!ParticleEffect.isColorCorrect(this, color)) throw new ParticleColorException("The particle color type is incorrect");
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException {
        if (!this.isSupported()) throw new ParticleVersionException("This particle effect is not supported by your server version");
        if (!this.hasProperty(ParticleProperty.REQUIRES_DATA)) throw new ParticleDataException("This particle effect does not require additional data");
        if (!ParticleEffect.isDataCorrect(this, data)) throw new ParticleDataException("The particle data type is incorrect");
        ...
        private void initializePacket(Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (ParticlePacket.version < 8) {
                    ...
                    ReflectionUtils.setValue(packet, true, "a", ParticlePacket.enumParticle.getEnumConstants()[effect.getId()]);
